# How the Buyer Pass works

> **Website:** This article is registered in `AdminContext.tsx` under **Using the App** with hero image:  
> `https://iawkgqbrxoctatfrjpli.supabase.co/storage/v1/object/public/assets/Images/buyer-pass_help.png`

> **Optional local asset:** You can also use `public/images/buyer-pass-help-hero.png` at `/images/buyer-pass-help-hero.png` if you mirror the illustration locally.
